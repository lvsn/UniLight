...
# Modified by Zitian Zhang for the UniLight project, Aug 2025
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                latent_model_input = torch.cat([latents, control_image], dim=1) if control_image is not None else latents
